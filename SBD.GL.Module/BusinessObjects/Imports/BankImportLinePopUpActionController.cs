...
namespace SBD.GL.Module.BusinessObjects.Imports
{
    ...
    public partial class BankImportLinePopUpActionController : ViewController
    {
        public BankImportLinePopUpActionController()
        {
            InitializeComponent();
        ...
        {
            var account = e.PopupWindowViewCurrentObject as Account;
